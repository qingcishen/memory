...
当前首个自动信念投影是用户的显式当前活动：例如“我正在开会”“我开车呢”。系统只
接受窄范围的现在时陈述，不采信计划、过去式、否定句或助手代述；活动按类型设置
1–12 小时有效期，供下一轮时间感知判断“这件事是否应该已经结束”。

稳定偏好与身份事实也会随长期记忆投影，但必须同时通过 user 本人归因、原消息逐字
证据和受控谓词白名单。belief evidence 关联来源 memory id；用户主动遗忘该记忆时，
对应证据以及失去全部来源的 belief 会一起删除。
