...
本文档的 M/L/A/K 线已全部落地。后续 D/B/S 等升级的历史设计已归档到 **[伴侣升级开发文档 v2](archive/companion-upgrade-v2.md)**；当前完成度与后续任务以 **[五系统升级文档](tech-breakthrough-v1.md)** 和 **[协作日志](collab.md)** 为准。亲密/性爱运行时状态见 **[性爱系统开发文档 I 线](intimacy-design.md)**。
