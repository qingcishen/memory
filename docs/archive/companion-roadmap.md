...
> **归档说明（2026-08-11）**：这是早期 M0–M5 总路线，相关主线已落地，文末“下一步”不再代表当前计划。当前开发状态以 [`../tech-breakthrough-v1.md`](../tech-breakthrough-v1.md)、[`../continuous-existence-engine.md`](../continuous-existence-engine.md) 和 [`../collab.md`](../collab.md) 为准。
