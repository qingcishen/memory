...
ok('原有八种标签都存在', ['平静','开心','委屈','吃醋','生气','失落','撒娇','心疼'].every(l => EMOTION_LABELS.includes(l)));
...
ok('女同事+漂亮修饰 → 吃醋', inferEmotionLabel(state(), {}, user('今天认识了一个很漂亮的女同事，聊了好久')) === '吃醋');
ok('我很生气+算了吧 → 生气（不依赖 tension）', inferEmotionLabel(state(), {}, user('你怎么这样，算了吧，我很生气')) === '生气');
