...
console.log('RelationshipAdapter.bump / StateLayerAdapter.evolve 在本系统里都是 no-op (增量已随 memory.observe 完成)');
{
  ...
  ok('stateLayer.evolve 不连网且不抛错', (await stateLayer.evolve([])) === undefined);
