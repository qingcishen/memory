...
console.log('RelationshipAdapter.bump / EmotionAdapter.update 在本系统里都是 no-op (增量已随 memory.observe 完成)');
{
  ...
  ok('emotion.update 不连网且不抛错', (await emotion.update()) === undefined);
