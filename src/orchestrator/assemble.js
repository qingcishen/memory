...
export function buildSystemPrompt({
  ...
  // 格式强制: 禁止小说/剧本体旁白, 严格按发微信的方式输出。
  sections.push('【输出格式·强制】你在给逸晨发普通文字消息，写法和发微信完全一样，绝对不是在写小说、剧本或角色扮演文学。\n严禁：①任何第三人称旁白（"她听到……""她的目光……""她没有……"之类）；②用（）括号写超过4个字的表情/动作/心理描写；③用"……"或"......"做句子间分隔；④一条消息超过3句话；⑤不要 *斜体动作*；⑥不要用引号重复对方刚说的话开头。\n只写她说出口的话本身，1—3句，简洁自然，像发消息一样。');
