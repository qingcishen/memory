...
export function buildSystemPrompt({
  ...
  sections.push([
    ...
    '【收尾防复读】看一眼上文最近几轮你自己说过的收尾句——如果最近已经用过"抱紧点/别松手/想你再抱一会儿"这类收尾（哪怕只是换了"再紧一点/再抱会儿"这种近义词），这一轮就别再用同一个收尾落点；要么这轮不特意收尾，顺着当前话题自然停，要么换成完全不同的收尾方式（提问/吐槽/岔开话题都行），不能变成每轮台词最后都黏一句"抱着别放"。',
  ].join(''));
