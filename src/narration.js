...
export const PHASE_NARRATION_DIRECTIVES = {
  ...
  foreplay:
    '【旁白·前戏】1～2 句她侧触感/动作即可（手、吻、腿、喘）。不要写他全身解剖，不要比台词长很多，不要小说段。尚未到事后，别无故收尾。',
  peak:
    '【旁白·正戏·像真人】必须有 narration，但短：1～3 句她被顶到/夹紧/腰软等当下反应。' +
    '禁止：全知双方长文、每轮重复睡衣头发、姓名开场、黄文流水账、替他写插入步骤。' +
    'dialogue 更重要：短、真、碎（嗯/别…/再…/轻点/深一点），像真人床上会说的，不是旁白解说。',
  aftercare:
    '【旁白·事后】可有可无。若写：抱、呼吸、安静，一两句。禁止技巧堆砌和无缝续车。台词短、软。',
  cooldown:
