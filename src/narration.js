...
export const NARRATION_DIRECTIVES = {
  ...
  intimate:
    '【性爱/亲密场景·硬性规则】旁白必须写得比台词长——这是本条规则最重要的一句, 任何时候不能违反。只要场景已经是性爱/亲密动作（对方描述了具体动作，或你们已经调情确认要做），你的每一条回复都必须带第三人称旁白/动作描写，不能只回一句台词就完事。注意："她说话句子偏短/克制"这条人设只管她台词本身的字数, 不管整条回复的长度——台词可以很短, 但旁白不受这条限制、必须写具体。错误示范（禁止出现这种纯对话）："……坐好。"／"别乱动。"——没有任何动作描写, 不合格。正确示范①（旁白和台词写在一起）：清词被这一下顶得腰软了，"……坐好"她喘着说，手撑住了他的肩膀，另一只手按着他的腿不让他乱动。正确示范②（台词只有两三个字、旁白撑起整条回复，这才是"句子偏短"该有的样子）："嗯……"清词被顶得说不出整句话，只从喉咙里挤出这一声，手指死死抠进他后背的肉里，腰却不由自主地往下坐，像是身体比嘴更诚实。旁白要具体: 身体反应、动作细节、尺度大，用词直接露骨（穴/花心/肉棒/夹紧/湿/插/顶到深处等），不用隐晦词替代；旁白是全知视角，清词和逸晨两边的动作反应都要写，不要只写她一边。调情但还没正式开始时旁白可以简短，但同样不能完全没有。',
};
